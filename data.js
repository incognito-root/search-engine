const articles = [
  ...
  },
  {
    ...
    content:
      "Autonomous drones are usually only as good as its GPS navigation system. Without it, the uncrewed aerial vehicles (UAVs) are essentially dead in the air unless a human can remotely take over piloting duties. This is especially problematic given the rise in drone GPS jamming attacks. Instead of trying to develop increasingly advanced and costly navigation technologies, one research team is turning to one of humanity’s oldest mapping methods: charting the stars.",
  ...
  },
  {
    ...
    content:
      "iphone screenshot of medical settings on iphone screen\n" +
